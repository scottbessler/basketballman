...
#[test]
fn generated_schedule_has_valid_games_and_82_per_team() {
    ...
    assert_eq!(league.schedule.len(), 1230);
    ...
    assert!(counts.values().all(|count| *count == 82));
}

#[test]
fn simulation_persists_one_positive_result_and_winner() {
...
#[tokio::test]
async fn ssr_routes_work_without_javascript_and_simulate_persists() {
